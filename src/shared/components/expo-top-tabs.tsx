...
import { TabItemProps } from "react-native-collapsible-tab-view";

const Nav = createCollapsibleNavigator().Navigator;
...
export const TopTabs = ({
  ...
  options?: Partial<TabItemProps<any>>;
}) => {
  // Allows adding Screen components as children to configure routes.
  const { screens, children: otherChildren } = useFilterScreenChildren(children, {
