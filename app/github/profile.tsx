...
export default function Profile() {
  ...
  return (
    ...
    >
      ...
      <View className="w-full h-12 bg-neutral-950 rounded-xl mb-6" />

      <View className="w-3/4 h-4 bg-neutral-950 rounded-md mb-1" />
      <View className="w-1/2 h-4 bg-neutral-950 rounded-md mb-4" />

      <View className="w-32 h-4 bg-neutral-950 rounded-md mb-4" />

      <View className="flex-row items-center gap-1 mb-6">
        <View className="w-4 h-4 rounded-full bg-neutral-950" />
        <View className="w-16 h-4 bg-neutral-950 rounded-md" />
        <View className="w-4 h-4 rounded-full bg-neutral-950" />
        <View className="w-20 h-4 bg-neutral-950 rounded-md" />
      </View>
      <View className="gap-[2px] mb-10">
        <View className="w-full h-12 bg-neutral-950 rounded-lg" />
        <View className="w-full h-12 bg-neutral-950 rounded-lg" />
        <View className="w-full h-12 bg-neutral-950 rounded-lg" />
      </View>
      <View className="w-1/3 h-4 bg-neutral-950 rounded-md mb-4" />
      <View className="w-full h-40 bg-neutral-950 rounded-xl mb-6" />
    </Animated.ScrollView>
  );
}
